...
import { fetchCart, productFetchCustomer, placeFetchCart, cartQuantity, placeOrder } from 'src/urls/urls'
...
const ProductsCustomer = () => {
  ...
  const placeOrderFun = () => {
    placeOrderFetch(placeOrder(cartOrders))
  }
      ...
      <Drawer
        ...
        extra={
          <Space>
            ...
            <Button type="primary" onClick={()=>placeOrderFun()}>
              Order
            </Button>
        </Space>
        }
